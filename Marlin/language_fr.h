...
#define MSG_LCD_OK                          _UxGT("OK")
#define MSG_PINCH                           _UxGT("Pincez la feuille")
#define MSG_SET_OFFSET                      _UxGT("en reglant l'offset")
#define MSG_VALIDATE                        _UxGT("puis validez")
#define MSG_ADD_SHEET                       _UxGT("Glissez une feuille")
#define MSG_BESIDE_NOZZLE                   _UxGT("en dessous de la buse")
#define MSG_CLICK_OK                        _UxGT("puis appuyez sur OK")
#define MSG_PARALLEL_X                      _UxGT("Parrallel X")
...
#define MSG_Z_OFFSET                        _UxGT("Regl. Z Offset")
...
#define MSG_PREPARE_ADVENCED                _UxGT("Options avancées")
...
#endif
#define MSG_PARAMETERS                      _UxGT("   Paramètres")
#define MSG_SAVED                           _UxGT("   Sauvegardes")
