...
/**
 * OK button
 * Push button linked to a free pin to get user input without LCD panel.
 *
 * This feature is required for the default ADVANCED_PAUSE_FEATURE when no LCD panel is configured.
 */
#define OK_BUTTON
#define OK_BUTTON_PIN 65       // A11 free pin on MKS base 1.2
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define PAUSE_PARK_X_POS 15                 // X position of hotend
  #define PAUSE_PARK_Y_POS 15                 // Y position of hotend
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH   10  // Unload filament length from hotend in mm
